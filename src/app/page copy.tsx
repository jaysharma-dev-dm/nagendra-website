...
const Page = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-orange-500 via-white to-green-500 animate-gradient-move relative">
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center h-screen p-5 md:p-10 gap-5 md:gap-10">
        <div className="flex-1 space-y-6 text-center md:text-left">
          ...
          <button className="bg-blue-900 text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-800 transition duration-200">
            {t.learnMore}
          </button>
        </div>
      ...
      {/* About Section */}
      <section id="about" className="flex flex-col md:flex-row items-center p-5 md:p-10 bg-white rounded-lg shadow-md gap-5 md:gap-10">
        <div className="flex-1 w-full">
      ...
      {/* My Work Section */}
      <section id="work" className="flex flex-col p-5 md:p-10 bg-gray-50 rounded-lg shadow-md gap-5 md:gap-10">
        ...
        <div className="overflow-x-auto flex gap-6 pb-4">
          <div className="min-w-[250px] md:min-w-[300px] p-6 bg-white shadow-lg rounded-lg">
      ...
      <section id="initiatives" className="flex flex-col p-5 md:p-10 bg-white rounded-lg shadow-md gap-5 md:gap-10">
        <h2 className="text-3xl md:text-4xl font-semibold text-blue-900 text-center mb-6">{t.initiativesTitle}</h2>
        <div className="overflow-x-auto flex gap-6 pb-4">
          <div className="min-w-[250px] md:min-w-[300px] p-6 bg-gray-50 shadow-lg rounded-lg">
      ...
      <section id="achievements" className="p-5 md:p-10 bg-gray-50 rounded-lg shadow-md text-center">
      ...
      {/* Contact Us Section */}
      <section id="contact" className="p-5 md:p-10 bg-white rounded-lg shadow-md text-center space-y-6">
